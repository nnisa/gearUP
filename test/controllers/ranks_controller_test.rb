...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { playerID: @rank.playerID, position: @rank.position, sportID: @rank.sportID }
    end
  ...
  test "should update rank" do
    patch :update, id: @rank, rank: { playerID: @rank.playerID, position: @rank.position, sportID: @rank.sportID }
    assert_redirected_to rank_path(assigns(:rank))
  end
